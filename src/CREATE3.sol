...
library CREATE3 {
    ...
    function getDeployed(address deployer, bytes32 salt) internal pure returns (address) {
        address proxy = keccak256(abi.encodePacked(bytes1(0xFF), deployer, salt, PROXY_BYTECODE_HASH))
            // Prefix:
            // Creator:
            // Salt:
            // Bytecode hash:
